...
import { exitProcess, onSignal } from "../../core/os/process.js";
import { createObsidiClawStack } from "../../entry/stack.js";

const __dirname = fileURLToPath(new URL(".", import.meta.url));
// When running from dist/, go up three levels (dist/agents/orchestrator/ → project root).
// When running from source via tsx, go up two levels (agents/orchestrator/ → project root).
...
const orchestrator = new Orchestrator(stack.logger, stack.engine);
