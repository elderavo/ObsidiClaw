...
You will receive a mirror note describing a source file (its imports, exports, and call graph), the source file itself, and optionally a `## Child Summaries` section containing a description of the file's exported symbols.

## Instructions

Write short technical description of what this file does and why it exists, given its symbols and connections. The description must be useful to a coding agent navigating the codebase.
