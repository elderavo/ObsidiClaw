...
import { ContextEngine, createContextEngineMcpServer } from "../dist/knowledge/engine/index.js";
import { createObsidiClawExtension } from "../dist/entry/extension.js";
import { RunLogger } from "../dist/logger/run-logger.js";
import { runSessionReview } from "../dist/agents/insight/session_review.js";

const OLLAMA_BASE_URL = process.env["OLLAMA_BASE_URL"] ?? process.env["OBSIDI_LLM_HOST"] ? `${process.env["OBSIDI_LLM_HOST"]}/v1` : "http://localhost:11434/v1";
const OLLAMA_MODEL = process.env["OLLAMA_MODEL"] ?? process.env["OBSIDI_LLM_MODEL"] ?? "cogito:8b";
