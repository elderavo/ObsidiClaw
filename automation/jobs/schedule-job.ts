 ...
 * All jobs run as: node dist/automation/jobs/run-job.js <job-name>
...
import type { PersistentScheduleBackend, ScheduledJob } from "../../core/os/scheduling.js";
...
export class JobScheduler {
  ...
  async start(): Promise<void> {
    ...
    const runnerScript = join(this.rootDir, "dist", "automation", "jobs", "run-job.js");
