...
var Orchestrator = /** @class */ (function () {
    function Orchestrator(logger, contextEngine) {
        this.logger = logger;
     ...
     */
    Orchestrator.prototype.createSession = function (config) {
        if (config === void 0) { config = {}; }
        return new session_js_1.OrchestratorSession(this.logger, this.contextEngine, config);
    };
    /**
     * Single-shot: create a session, send one prompt, dispose, return result.
     * Useful for scripting and testing.
     */
    Orchestrator.prototype.run = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, session, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, session.prompt(config.prompt)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, {
